...
<template>
  <div class="demo sa-border">
    <div class="flex items-center p-2 px-4 filter drop-shadow-md sa-light-dark rounded-xl z-1">
      <div class="w-full flex items-center gap-4">
        ...
        <div class="flex flex-grow items-center gap-2">
          ...
          <VButton icon class="demo-outline" @click="showToast = true">
            <tabler-bell />
          </VButton>
          ...
          <VDropdown v-model="showProfileMenu" class="demo-outline">
            <template #activator="{ toggle }">
              <!-- <VAvatar
                ...
                class="border-2 border-gray-300 rounded-full overflow-hidden cursor-pointer"
                @click="toggle"
              />-->
            ...
            >
              <!-- <div
                v-for="option in profileMenuOptions"
                :key="option.label"
                class="whitespace-nowrap px-4 py-2 text-sm hover:bg-black hover:bg-opacity-10 cursor-pointer"
    ...
    <div class="py-3 overflow-y-auto flex-grow grid grid-cols-4 gap-4">
      <div class="col-span-4 md:col-span-3">
        <DemoGallery class="h-full rounded-lg" />
      </div>
      <DemoProgress class="demo-card p-0 col-span-full md:col-span-1" />
      <div class="col-span-full bg-dark-50 dark:bg-transparent rounded-lg">
