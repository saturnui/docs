...
<template>
  <div class="p-8 space-y-6">
    <div class="vuwi-window filter drop-shadow-lg relative">
      ...
      <Line />
      <div class="font-bold text-sm bg-gray-100 dark:bg-gray-700 px-4 py-2">Headless</div>
      ...
      <div class="font-bold text-sm bg-gray-100 dark:bg-gray-700 px-4 py-2">Header</div>
      <div class="px-4 py-3 flex">
        <Collapse v-model="open" class="w-full">
      ...
      <div class="px-4 py-3 -space-y-1">
        <Collapse v-for="i in 3" :key="i" group="myCustomGroup" class="w-full">
          <template #header="{ open: isOpen }">
            <div
              class="relative p-3 flex items-center gap-4 w-full vuwi-border z-0 vuwi-light-dark"
            >
    ...
    <div class="vuwi-window filter drop-shadow-lg relative">
      ...
      <div class="p-4 vuwi-dark text-sm text-teal-400">
        <pre><code>&lt;Collapse v-model="open" class="w-full">
  &lt;template #header="{ open: isOpen }">
    &lt;div
      class="relative p-3 flex items-center gap-4 w-full vuwi-border z-0 vuwi-light-dark">
      &lt;span class="font-bold flex-grow">Title here&lt;/span>
