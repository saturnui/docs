<template>
  ...
  <VAlert class="sa-warning text-sm font-medium p-2" role="alert">
  ...
  <VAlert class="sa-info text-sm font-medium p-2" role="alert">
  ...
  <VAlert class="sa-success text-sm font-medium p-2" role="alert">
