...
<template>
  <div class="relative flex w-full h-screen">
    <div class="relative flex flex-col h-full w-full">
      <div
        class="fixed sa-tl w-full flex items-center sa-dark border-b sa-border p-2 sm:pl-6 max-h-14 min-h-14 z-1"
      >
    ...
    <VOverlay v-model="showDrawer" class="z-10" position="left">
      <div class="h-full flex flex-col bg-dark-700 border-r sa-border overflow-y-auto">
