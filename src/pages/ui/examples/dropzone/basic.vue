    ...
    <template #default="{ active, files }">
      ...
      >
        ...
        >
          ...
          <button
            class="absolute -top-2 -right-2 vuwi-btn vuwi-btn-icon bg-black border-3"
      ...
      <div class="py-2">
        <div class="flex gap-2 px-3 py-2 vuwi-text bg-dark-50 dark:bg-gray-900 rounded font-medium">
